...
Post Snippets gives you the power to build a library with snippets of HTML, PHP code or reoccurring text that you often use in your posts and pages. You can use predefined variables to replace parts of the snippet on insertion. 

All snippets are available in the post editor via an accress button in the "Visual" mode. The snippets can be inserted as defined, or as a shortcode to keep flexibility for updating the snippet. PHP code is supported for snippets inserted as shortcodes.

For easiness, snippets can be imported and exported between sites and if you delete the plugin from your plugins panel, all created data will be cleaned automatically.

= Features =

* **Insert Snippets** - All defined snippets are inserted from a button directly into the post editor.
* **Create Custom Shortcodes** - You can use this plugin to create custom shortcodes.
* **Process as PHP Code** - A shortcode snippet can optionally be processed as PHP code.
* **Quicktag** - The snippets can be found in the (visual) WordPress editor with a button and in the HTML editor with a quicktag.
* **User-friendly** - Easy to use 'Manage Snippets' page where you can add, edit and remove snippets.
* **Custom Variables** - Each snippet can have as many custom variables as you like, which can be used on insert.
* **Import/Export** - Snippets can be imported and exported between sites.
* **Documentation** - The complete documentation is available directly from the help panel in the plugin.
* **Smart Data Cleanup** - If you delete the plugin from your plugins panel it cleans up all data it has created in the WordPress database.

Read the complete documentation [here](https://www.postsnippets.com/documentation/)

= Post Snippets Pro =

Post Snippets Pro empowers WordPress website owners to easily duplicate shortcode snippets and insert them into pages and posts. With the built-in advanced Rich Text editor you can do customization to your snippet codes however you want. The modern back-end UI and express-validator library simplifies the process of standard validation, sanitation, and escaping.

= Post Snippets Pro Features = 

* **Snippet duplication** - Easily duplicate shortcode snippets and insert them into posts and pages.
* **Snippets Cloud** - Upload and download your snippets from snippet cloud.
...
* **Plugin code revamped** - Plugin code has been updated to create a more powerful library with snippets of HTML, PHP code, or recurring text.
* **Added sanitation, escaping, and validation** - express-validator library simplifies the process of standard validation, sanitation, and escaping.
* **Cloud upload and download** - Snippets can be uploaded and downloaded via Snippet Cloud.
* **Separate DB Table** - Snippets are now saved in a separate DB table instead of an options table.
* **Modern backend UI** - easy-to-use and powerful UI.
* **Bulk Actions now include Activate and Deactivate** — Bulk actions such as activation and deactivation are now available.
* **Post Editor screen for snippets** - Add or change the text using the post editor screen.
* **Snippets are now displayed as table lists** - Table snippets are frequently displayed in search results for rates or pricing lists.
* **Snippets Groups** - Each snippet is classified into related snippet groups.
* **Delete snippets on uninstalling plugins** - When a plugin is uninstalled, there is an option to delete snippets.
* **Bugs in the block editor** - The new version includes additional refinement with bug fixes in the block editor.

Download Post Snippets Pro Today - [visit our Website](https://www.postsnippets.com/)
...
= Version 3.1.7 - 3 Mar 2022 =

* Updated Freemius SDK Version 2.4.3

= Version 3.1.6 - 2 Feb 2022 =
 ...
 * Included Polish translation (pl_PL) by Tomasz WesoÅ‚owski.
